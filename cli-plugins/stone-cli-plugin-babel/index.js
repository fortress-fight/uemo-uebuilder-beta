...
module.exports = (api, options) => {
    ...
    const cliServicePath = path.dirname(require.resolve("@stone/vue-cli-service"));
    ...
    api.chainWebpack((webpackConfig) => {
        ...
        if (useThreads) {
            const threadLoaderConfig = jsRule.use("thread-loader").loader(require.resolve("thread-loader"));
