...
<template>
    ...
    >
        <UeTiptap<%- elementName %> v-bind="testValue">
            <!--  -->
        </UeTiptap<%- elementName %>>
    </TestArea>
</template>
...
const testValueList:(UE_TIPTAP_COMPONENT.UeTiptap<%- elementName %>Props & {testOptionTitle?: string; value?: any})[] = [{}];
