<!--
 * @Description: 测试背景SVG控制器组件
 * @Author: F-Stone
 * @LastEditTime: 2025-03-26 03:21:42
-->
<template>
    <TestArea
        ...
        title="测试背景SVG控制器组件"
    >
        <UeElBackgroundSvgSettingPanel v-bind="testValue" v-model:value="testValue.value">
            <!--  -->
...
const testValueList: (UE_EL_COMPONENT.UeElBackgroundSvgSettingPanelProps & {
