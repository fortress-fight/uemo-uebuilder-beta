 ...
 * @Description: 测试间隔控制组
 * @Author: F-Stone
 * @LastEditTime: 2025-06-29 03:01:51
-->
<template>
    <TestArea
        ...
        title="测试间隔控制组"
    >
        <UeElGapSettingGroup v-bind="testValue" v-model:value="testValue.value">
            <!--  -->
        </UeElGapSettingGroup>
    </TestArea>
</template>
...
const testValueList: (UE_EL_COMPONENT.UeElGapSettingGroupProps & { testOptionTitle?: string; value: string })[] = [
    { value: "10px" },
];
