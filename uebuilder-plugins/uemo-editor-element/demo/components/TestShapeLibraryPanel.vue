<!--
 * @Description: 测试图形资源面板
 * @Author: F-Stone
 * @LastEditTime: 2025-03-07 12:31:17
-->
<template>
    <TestArea
        ...
        title="测试图形资源面板"
    >
        <UeElShapeLibraryPanel v-bind="testValue" v-model:select="testValue.select">
            <!--  -->
...
const testValueList: (UE_EL_COMPONENT.UeElShapeLibraryPanelProps & { testOptionTitle?: string; select: string })[] = [
    { select: "" },
];
