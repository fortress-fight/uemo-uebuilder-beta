<!--
 * @Description: 测试spline资源面板
 * @Author: F-Stone
 * @LastEditTime: 2025-03-07 15:52:57
-->
<template>
    <TestArea
        ...
        title="测试spline资源面板"
    >
        <UeElSplineLibraryPanel v-bind="testValue" v-model:select="testValue.select">
            <!--  -->
...
const testValueList: (UE_EL_COMPONENT.UeElSplineLibraryPanelProps & { testOptionTitle?: string; select?: string })[] = [
    { select: "" },
];
