<!--
 * @Description: 测试边框控制器组
 * @Author: F-Stone
 * @LastEditTime: 2025-03-03 02:30:51
-->
<template>
    <TestArea
        ...
        title="测试边框控制器组"
    >
        <UeElBorderSettingGroup v-bind="testValue" v-model:value="testValue.value">
            <!--  -->
...
const testValueList: (UE_EL_COMPONENT.UeElBorderSettingGroupProps & { testOptionTitle?: string; value?: any })[] = [
    { value: undefined },
];
