...
<template>
    <TestArea
        ...
        title="测试滚动效果属性控制组"
    >
        <UeElScrollEffectSettingGroup v-bind="testValue">
            <!--  -->
...
const testValueList: (UE_EL_COMPONENT.UeElScrollEffectSettingGroupProps & { testOptionTitle?: string; value?: any })[] =
    [{}];
