 ...
 * @Description: 测试菜单组件
 * @Author: F-Stone
 * @LastEditTime: 2025-05-25 10:47:28
-->
<template>
    <TestArea
        ...
        title="测试菜单组件"
    >
        <UeElContextmenu v-bind="testValue">
            <!--  -->
        </UeElContextmenu>
    </TestArea>
</template>
...
const testValueList: (UE_EL_COMPONENT.UeElContextmenuProps & { testOptionTitle?: string })[] = [
    {
        list: [
            [
                {
                    ...
                    subList: [
                        [
                            { type: "pastAttrs", text: "粘贴属性", hotkey: "⌘+V", enable: true },
                            {
                                type: "pastAttrs",
                                text: "粘贴属性",
                                hotkey: "⌘+V",
        ...
        trigger: (data: UE_EL_COMPONENT.UeElContextmenuProps["list"][number][number]) => {
