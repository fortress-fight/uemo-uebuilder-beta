...
import UeElBackgroundSvgSettingPanel from "../packages/background-svg-setting-panel";
import UeElBackgroundVideoSettingPanel from "../packages/background-video-setting-panel";
...
import UeElBrowserMockupPanel from "../packages/browser-mockup-panel";
...
import UeElButtonHoverEffectSetting from "../packages/button-hover-effect-setting";
...
import UeElCounterNumberPreviewPanel from "../packages/counter-number-preview-panel";
...
import UeElWebSettingPanel from "../packages/web-setting-panel";
import UeElWidthSettingGroup from "../packages/width-setting-group";
...
export const components = [
    ...
    UeElBackgroundSvgSettingPanel,
    UeElBackgroundVideoSettingPanel,
    UeElBorderSetting,
