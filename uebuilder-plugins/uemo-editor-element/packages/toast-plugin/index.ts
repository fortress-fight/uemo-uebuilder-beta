 ...
 * @Author: F-Stone
 * @LastEditTime: 2025-07-20 16:44:21
 */
...
export function createToast(param: PluginOptions = {}) {
    return createToastInterface({ ...defaultParam, ...param });
}
