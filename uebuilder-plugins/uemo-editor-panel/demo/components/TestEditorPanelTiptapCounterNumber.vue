<!--
 * @Description: 测试Tiptap计数器编辑面板
 * @Author: F-Stone
 * @LastEditTime: 2025-07-07 10:49:31
-->
<template>
    <TestArea
        ...
        title="测试Tiptap计数器编辑面板"
    >
        <UeEditorPanelTiptapCounterNumber v-bind="testValue" v-model:value="testValue.value">
            <!--  -->
...
const testValueList: (UE_EDITOR_PANEL_COMPONENT.UeEditorPanelTiptapCounterNumberProps & {
    testOptionTitle?: string;
    value: UE_TIPTAP_EXTENSION.CounterNumber["attrs"];
})[] = [
    {
        value: {
            gap: "1em",
