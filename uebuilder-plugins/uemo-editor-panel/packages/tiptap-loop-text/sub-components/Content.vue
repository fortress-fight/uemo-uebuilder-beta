<template>
    <UeElSettingGroup
        ref="rootDomRef"
        :class="$style['tiptap-loop-text-content']"
                ...
                <UeElDraggable v-model:value="sortList" class="grid gap-1" ref="draggerListGroupRef">
                    ...
                    >
                        ...
                        >
                            ...
                            <div :class="$style['title']" :title="item.title">
...
function editorItem(item: UE_TIPTAP_EXTENSION.LoopText["attrs"]["body"][number]) {
